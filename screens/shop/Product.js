    ...
    <ScrollView>
      ...
      <View style={styles.actions}>
        <Button
          ...
          title='Add to Cart'
          onPress={() => dispatch(cartActions.addToCart(selectedProd))}
        />
      </View>
...
export const prodScreenOptions = navData => {
  const title = navData.route.params ? navData.route.params.productTitle : "";
  return {
    headerTitle: title
  };
};
